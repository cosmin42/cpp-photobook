...
foreach(_cmake_expected_target IN ITEMS dp::thread-pool)
...
# Create imported target dp::thread-pool
add_library(dp::thread-pool INTERFACE IMPORTED)
...
file(GLOB _cmake_config_files "${CMAKE_CURRENT_LIST_DIR}/thread-pool-targets-*.cmake")
