...
namespace PhotobookNet
{
    ...
    public sealed partial class DashboardPage : Page, PhotobookListener
    {
        ...
        public void OnMappingFinished(string path, uint imagesCount)
        {
            throw new NotImplementedException();
        }
        ...
        public void OnLutAppliedOnDiskInMemory(Guid lutId)
        {
            throw new NotImplementedException();
        }
        ...
        public void OnLutAppliedOnDisk(Guid lutId, VirtualImagePtr image)
        {
            throw new NotImplementedException();
        }
    }
